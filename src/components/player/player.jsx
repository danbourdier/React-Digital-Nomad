...
// i want to structure context so its easier to logically manipulate both at once
  ...
  return (
    <div id="location-player-container">
      ...
      <locationURL.Provider value={{ 'France': '09oFgM5IHSI', 'NYC': 'eZe4Q_58UTU', 'Columbia': 'FBDLlpg1P_I', 'Germany': 'mlS89Cd176M', 'HongKong': 'H50az3Aq7x4', 'India': 'XRU9omrRV64', 'Italy': 'lpo62RjldVA' } }>
        <LocationControls />
